window.onload = function() {
    ...
    var einkehr = [
        L.marker([47.439611, 11.686361], {
            title: "Langlaufstüberl",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.426412, 11.728365], {
            title: "Seealm",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.539914, 12.567615], {
            title: "Seerestaurant Blattl",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.584216, 12.570386], {
            title: "Alte Schmiede Weinstube- Pizzeria",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.130788, 11.405729], {
            title: "Maria Waldrastgasthof",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.162357, 11.366385], {
            title: "Kirchbrücke Restaurant",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.561463, 12.414330], {
            title: "Käserei",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.603940, 12.382375], {
            title: "Gasthaus Hohenkendl",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.463504, 12.220496], {
            title: "Filzalm",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.497888, 12.197728], {
            title: "Hexenalm",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.342083, 10.899485], {
            title: "Marienbergalm",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.315646, 10.888394], {
            title: "Gasthof Aschlandhof",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.536741, 11.913402], {
            title: "Kaiserhaus",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.581662, 11.799271], {
            title: "Gufferthütte",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.259608, 10.876103], {
            title: "Gasthof Rafting Alm",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
        }),
        L.marker([47.241905, 10.878112], {
            title: "Oilers 69",
            icon: L.icon({
                iconUrl: 'icons/hut.png'
            })
    ...
    var start = [
        L.marker([47.392285, 11.267306], {
            title: "Startpunkt Karwendelrunde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.476926, 12.544588], {
            title: "Startpunkt Pillersee-Runde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.263363, 11.400469], {
            title: "Startpunkt Maria Waldrast-Runde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.668861, 12.404069], {
            title: "Startpunkt Kaiserwinkl-Runde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.446109, 12.162167], {
            title: "Startpunkt Hohe Salve-Runde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.319768, 10.830670], {
            title: "Startpunkt Marienbergjoch-Runde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.536660, 11.913398], {
            title: "Startpunkt Guffertrunde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.198614, 10.902923], {
            title: "Startpunkt Runde im vorderen Ötztal",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        })
    ...
    var ziel = [
        L.marker([47.392200, 11.267300], {
            title: "Endpunkt Karwendelrunde",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        }),
        L.marker([47.476900, 12.544500], {
            title: "Endpunkt Pillersee-Runde",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        }),
        L.marker([47.263300, 11.400400], {
            title: "Endpunkt Maria Waldrast-Runde",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        }),
        L.marker([47.668800, 12.404000], {
            title: "Endpunkt Kaiserwinkl-Runde",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        }),
        L.marker([47.446100, 12.162100], {
            title: "Endpunkt Hohe Salve-Runde",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        }),
        L.marker([47.319700, 10.830600], {
            title: "Endpunkt Marienbergjoch-Runde",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        }),
        L.marker([47.536600, 11.913300], {
            title: "Endpunkt Guffertrunde",
            icon: L.icon({
                iconUrl: 'icons/start-race-2.png'
            })
        }),
        L.marker([47.198600, 10.902900], {
            title: "Endpunkt Runde im vorderen Ötztal",
            icon: L.icon({
                iconUrl: 'icons/finish.png'
            })
        })
    ...
    var parken = [
        L.marker([47.392285, 11.267306], {
            title: "Parkplatz Karwendel",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.491241, 12.528752], {
            title: "Parkplatz Pillersee",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.263363, 11.400469], {
            title: "Parkplatz Maria Waldrast",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.663173, 12.396350], {
            title: "Parkplatz Kaiserwinkl",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.446109, 12.162167], {
            title: "Parkplatz Hohe Salve",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.315259, 10.843393], {
            title: "Parkplatz Marienbergjoch",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.536660, 11.913398], {
            title: "Parkplatz Guffertrunde",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        }),
        L.marker([47.198614, 10.902923], {
            title: "Parkplatz Vorderes Ötztal",
            icon: L.icon({
                iconUrl: 'icons/parken.png'
            })
        })
    ...
    var lohnendeStops = [
        L.marker([47.439611, 11.686361], {
            title: "Airrofan Skyglider - Rofan Cable Car Company",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.430991, 11.734883], {
            title: "Strandbad Buchau ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.500756, 12.571718], {
            title: "Jakobskreuz Aussichtspalttform ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.587565, 12.565102], {
            title: "Steinplatte Waidring Aussichtsplattform ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.130788, 11.405729], {
            title: "Maria Waldrast Klosteranlage ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.136798, 11.453339], {
            title: "Pfarrkirche Mariä Himmelfahrt ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        ...
        L.marker([47.557505, 12.447250], {
            title: "Museum Metzgerhaus ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.462960, 12.224004], {
            title: "Baden Filzalmsee ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.480283, 12.197561], {
            title: "Hexenwasser ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.362701, 10.872196], {
            title: "Weißensee ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.345703, 10.817517], {
            title: "Fernstein ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.540150, 11.916547], {
            title: "Kaiserklamm ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.200440, 10.905384], {
            title: "Erlebnisbad Ötz ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
        }),
        L.marker([47.228989, 10.844389], {
            title: "Area 47 ",
            icon: L.icon({
                iconUrl: 'icons/sight-2.png'
            })
